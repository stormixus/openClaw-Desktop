<script lang="ts">
  import { mines3dStore, askAgent, agentLoading, tokenHistory, tokensUsed } from '../store/mines3dStore';
...
<div class="panel">
  ...
  <p>{$mines3dStore.agentSpeech || 'Click to reveal cells, or ask the AI for analysis.'}</p>
  {#if !gwStore.activeGatewayId}
